...
-- Description:  Multiplexing 8-digit 7-segment display driver. It cycles 
--               through individual digits at approximately 762 Hz, decoding 
--               4-bit hex inputs into 7-segment active-LOW cathode signals. 
--               It also manages decimal points for time formatting and supports 
--               custom characters (blank and 'L' for Lap mode).
-- 
-- Revision:
